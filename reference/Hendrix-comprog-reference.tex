...
There are two main methods to do a topological sort.  Method 1 is to
repeatedly remove nodes with no incoming edges (or dually, nodes with
no outgoing edges).  Empirically this seems to be faster than Method
2, but is perhaps a bit more code.  Pseudocode is as follows:
...
\todo{write about method 2 via DFS}
\todo{mention topsort + DP}
